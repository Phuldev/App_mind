...
@section('content')
        ...
        {{-- secrch box --}}
        <section class="container d-flex bg-success">
            <input type="text" class="form-control w-75" placeholder="Search by job title">
            <button class="btn btn-info my-2 my-sm-0 m-2 text-center w-25" type="submit">Search</button>
        </section>
        </section>
        {{-- search box --}}
        ...
        <section class="container">
            <div class="right-s">
                <div class="card">
                    <div class="card-header">Top Job</div>
                    <div class="d-flex">
                        <div class="card-body">
            ...
            <div class="left-s">
                ...
                <div>
                    <div class="top-box">
                        <div class="card w-100%">
                            <div class="card-header">Top Employers</div>
                            <div class="card-body">
                ...
                <div>
                    <div class="top-box">
                        <div class="card w-100%">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-sm-between">
                                    <a href="#"><img src="../image/workers.png" height="50px" width="50px"
                                            alt="1st-pic"> &nbsp;</a>
                                    <a href="#"><img src="../image/workers.png" height="50px" width="50px"
                                            alt="1st-pic"> &nbsp;</a>
                                    <a href="#"><img src="../image/dev.jpeg" height="50px" width="50px"
                                            alt="1st-pic"></a>
                                </div>
                            </div>
                        </div>
                ...
                <div>
                    <div class="top-box">
                        <div class="card w-100%">
                            <div class="card-header">Jobs By Industry</div>
                            <div class="card-body">
                ...
                <div>
                    <div class="top-box">
                        <div class="card w-100%">
                            <div class="card-header">Jobs By Employment Type </div>
                            <div class="card-body">
                                <div style="text-decoration: none;">
                ...
                <div>
                    <div class="top-box">
                        <div class="card w-100%">
                            <div class="card-header">Recent Job Kurakani</div>
                            <div class="card-body">
                                <div class="d-flex">
