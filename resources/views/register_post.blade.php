    ...
    <div class="form-hr-rs">
        <div class="container">
            <div class="hr-form-header text-center">
                <h1 class="text-success text-bold text-capitalize">Create your free Employer Account</h1>
                <p style="font-size: 20px">Fill the basic information and start recruiting now! </p>
            </div>
            <form>
                <div class="input-group mb-2 mr-sm-2">
                  ...
                  <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder=" Enter Organization Name">
                </div>
              ...
              <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="text" class="form-control" id="inlineFormInputGroupUsername2" placeholder=" Enter Organization Contact Number">
              </div>
              ...
              <div class="input-group mb-2 mr-sm-2">
                ...
                <input type="email" class="form-control" id="inlineFormInputGroupUsername2" placeholder="Enter Organization E-mail">
              </div>
              ...
              <p class="text-with-login">Already have an employer account?
